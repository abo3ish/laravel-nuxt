<template>
  <div class="card card-pink">
    ...
    <div class="card-body">
      ...
      <br>
      <br>
      By accessing the website at http://kashwedawaa.com, you are agreeing to be bound by these terms of
      ...
      kashwedawaa's website for personal, non-commercial transitory viewing only. This is the grant of a license,
      not a transfer of title, and under this license you may not:
      <br>
      modify or copy the materials; use the materials for any commercial purpose, or for any public display
      (commercial or non-commercial);
      attempt to decompile or reverse engineer any software contained on kashwedawaa's website; remove any copyright
      ...
      terminated by kashwedawaa at any time. Upon terminating your viewing of these materials or upon the
      ...
      <br>
      <br>
      The materials on kashwedawaa's website are provided on an 'as is' basis. kashwedawaa makes no warranties, expressed
      ...
      <br>
      Further, kashwedawaa does not warrant or make any representations concerning the accuracy, likely results, or
      ...
      <br>
      <br>
      In no event shall kashwedawaa or its suppliers be liable for any damages (including, without limitation,
      damages for loss of data or profit, or due to business interruption) arising out of the use or inability
      to use the materials on kashwedawaa's website, even if kashwedawaa or a kashwedawaa authorized representative has been
      ...
      <br>
      <br>
      The materials appearing on kashwedawaa's website could include technical, typographical, or photographic
      errors. kashwedawaa does not warrant that any of the materials on its website are accurate, complete or
      current. kashwedawaa may make changes to the materials contained on its website at any time without notice.
      However kashwedawaa does not make any commitment to update the materials.
      <br>
      <br>
      6. Links
      <br>
      <br>
      kashwedawaa has not reviewed all of the sites linked to its website and is not responsible for the contents of
      any such linked site. The inclusion of any link does not imply endorsement by kashwedawaa of the site. Use of
      ...
      <br>
      <br>
      kashwedawaa may revise these terms of service for its website at any time without notice. By using this
      ...
      <br>
      <br>
      These terms and conditions are governed by and construed in accordance with the laws of KSA and you
      irrevocably submit to the exclusive jurisdiction of the courts in that State or location.
      <br>
      <br>
      <h5> Privacy Policy </h5>
      <br>
      Your privacy is important to us. It is kashwedawaa's policy to respect your privacy regarding any information
      we may collect from you across our website, http://kashwedawaa.com, and other sites we own and operate.
      <br>
      <br>
      ...
      feel free to contact us at kashfwedawaa@gmail.com.
      <br>
      <br>
    </div>
  </div>
